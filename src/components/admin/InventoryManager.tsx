        ...
        <div className="flex flex-col gap-8 h-full relative">
            <div className="flex justify-between items-end">
                <div>
                    ...
                    <p className="text-white/40 text-sm">Manage assets and catalog items across all regions.</p>
                </div>
                <button
                    onClick={() => {
                        setIsNewAsset(true);
                ...
                <div className="w-2/3 flex flex-col gap-4 overflow-y-auto pr-4 custom-scrollbar">
                    ...
                    <div className="grid grid-cols-1 gap-4">
                        {products.filter(p => p.name.toLowerCase().includes(searchTerm.toLowerCase()) || p.category.toLowerCase().includes(searchTerm.toLowerCase())).map((product) => (
                            ...
                            >
                                <div className="w-20 h-20 rounded-xl bg-black border border-white/10 overflow-hidden flex items-center justify-center relative bg-gradient-to-br from-gray-900 to-black">
